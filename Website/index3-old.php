...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link" href="index2-old.php">Monitoring Energi Panel Surya</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" href="index3-old.php">Monitoring Tip Bucket</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    ...
    <script>
        ...
        function loadRealtimeData() {
            $.ajax({
                url: 'realtime_data3.php', // Ganti dengan URL yang sesuai
                method: 'GET',
                dataType: 'html',
